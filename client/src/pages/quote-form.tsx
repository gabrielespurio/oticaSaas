...
import type { Customer, Product, InsertQuote, InsertQuoteItem } from "@shared/schema";
...
export default function QuoteFormPage() {
  ...
  const createQuoteMutation = useMutation({
    mutationFn: async (data: { quote: InsertQuote; items: InsertQuoteItem[] }) => {
  ...
  const onSubmit = (data: QuoteFormData) => {
    ...
    createQuoteMutation.mutate({ quote, items: quoteItems });
  };
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Novo Orçamento</h1>
      </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <Button
              ...
              disabled={createQuoteMutation.isPending || items.length === 0 || !selectedCustomer}
              className="w-full"
            >
